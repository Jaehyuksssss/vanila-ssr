...
describe("Theme System", () => {
  ...
  describe("applyTheme", () => {
    ...
    it("should apply theme tokens to custom element", () => {
      ...
      const primaryColor = testElement.style.getPropertyValue(
        "--vanila-theme-primary"
      );
    ...
    it("should apply multiple tokens", () => {
      ...
      expect(
        document.documentElement.style.getPropertyValue(
          "--vanila-theme-success"
        )
      ).toBe("#00ff00");
      expect(
        document.documentElement.style.getPropertyValue("--vanila-theme-danger")
      ).toBe("#0000ff");
    });
  });
  ...
  describe("applyThemeMode", () => {
    it("should apply light theme", () => {
      ...
      expect(document.documentElement.getAttribute("data-vanila-theme")).toBe(
        "light"
      );
      expect(
        document.documentElement.style.getPropertyValue("--vanila-theme-bg")
      ).toBe(lightTheme["--vanila-theme-bg"]);
    });
    ...
    it("should apply dark theme", () => {
      ...
      expect(
        document.documentElement.style.getPropertyValue("--vanila-theme-bg")
      ).toBe(darkTheme["--vanila-theme-bg"]);
    });
    ...
    it("should apply theme to custom element", () => {
      ...
      expect(testElement.getAttribute("data-vanila-theme")).toBe("dark");
      expect(testElement.style.getPropertyValue("--vanila-theme-bg")).toBe(
        darkTheme["--vanila-theme-bg"]
      );
    });
  });
  ...
  describe("removeTheme", () => {
    it("should remove all theme tokens from document root", () => {
      ...
      expect(
        document.documentElement.getAttribute("data-vanila-theme")
      ).toBeNull();
      expect(
        document.documentElement.style.getPropertyValue("--vanila-theme-bg")
      ).toBe("");
    ...
    it("should remove theme from custom element", () => {
      ...
      expect(testElement.getAttribute("data-vanila-theme")).toBeNull();
      expect(testElement.style.getPropertyValue("--vanila-theme-bg")).toBe("");
    });
  });
  ...
  describe("Theme tokens", () => {
    ...
    it("should have different colors for light and dark themes", () => {
      expect(lightTheme["--vanila-theme-bg"]).not.toBe(
        darkTheme["--vanila-theme-bg"]
      );
      expect(lightTheme["--vanila-theme-fg"]).not.toBe(
        darkTheme["--vanila-theme-fg"]
      );
    });
  });
});
