...
renderCards([
  { title: "Card 1", description: "Internal note", imageUrl: "/card.png" },
], "#card-container");
...
const filterBar = createFilterBar({
  fields: [
    { type: "search", name: "query", label: "Search", placeholder: "Project or owner" },
    {
      type: "select",
      name: "status",
      label: "Status",
...
const table = createDataTable({
  columns: [
    ...
    { key: "progress", header: "Progress", align: "right", render: (value) => `${value}%` },
  ],
  data: rows,
